...
export const createPost=async (req,res)=>{
    console.log('server handling post')
   let post=req.body;
...
export const updatePost=async (req,res)=>{
    console.log('inside update post server');
...
export const likePost=async (req,res)=>{
    console.log('inside likepodt server');
    ...
    await PostMessage.findByIdAndUpdate(id,post,{new: true}).then((data)=>{
        console.log(data);
